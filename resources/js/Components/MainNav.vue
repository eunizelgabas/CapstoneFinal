    ...
    <div>
        <div class="overflow-y-auto overflow-x-hidden flex-grow">
            <ul class="flex flex-col py-6 space-y-1">
              ...
              <li>
                <Link href="/dashboard" :active="route().current('dashboard')" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6">
              ...
              <li v-if="$page.props.auth.permissions.includes('manage-patient')">
                <Link :href="route('patient.index')" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6">
                  <span class="inline-flex justify-center items-center ml-4">
              ...
              <li>
                <Link v-if="$page.props.auth.permissions.includes('manage-doctors')" :href="route('doctor.index')" class=" relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6">
                  <span class="inline-flex justify-center items-center ml-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <li v-if="$page.props.auth.permissions.includes('manage-medicine')">
                ...
                <button  @click="isOpen" class="relative flex flex-row items-center cursor-pointer w-full h-11 focus:outline-none hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6">
                  ...
                  <div v-show="show"  class="flex justify-start ml-3 flex-col w-full md:w-auto items-start pb-1 ">
                        ...
                        <Link :href="route('medicine.index')" class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6 rounded px-3 py-2 w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <Link :href="route('stock.index')" class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6 rounded px-3 py-2 w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <Link :href="route('dispense.index')" class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6 rounded px-3 py-2 w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <Link :href="route('inventory.index')" class="flex justify-start items-center space-x-6 hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6 rounded px-3 py-2 w-full">
              ...
              <li v-if="$page.props.auth.permissions.includes('add-appointment')">
                <Link :href="route('appointment.index')" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6">
                  <span class="inline-flex justify-center items-center ml-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <li v-if="$page.props.auth.permissions.includes('manage-service')">
                <Link :href="route('service.index')" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6">
                  <span class="inline-flex justify-center items-center ml-4">
              ...
              <li>
                <Link href="#" class=" relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6">
                  <span class="inline-flex justify-center items-center ml-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <li v-if="$page.props.auth.permissions.includes('manage-user')">
                <Link :href="route('user.index')" class=" relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-100 text-white hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-900 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
