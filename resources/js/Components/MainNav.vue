    ...
    <div>
        <div class="overflow-y-auto overflow-x-hidden flex-grow">
            <ul class="flex flex-col py-2 space-y-1">
              ...
              <li :class="{ 'bg-blue-100 font-bold text-gray-800 border-l-4 border-transparent border-indigo-900 pr-6': route().current('dashboard') }">
              ...
              <li :class="{'bg-blue-100 font-bold text-gray-800 border-l-4 border-transparent border-indigo-900 pr-6': route().current('patient.index') }" v-if="$page.props.auth.permissions.includes('manage-patient')">
              ...
              <li  :class="{'bg-blue-100 text-gray-800 font-bold border-l-4 border-transparent border-indigo-900 pr-6': route().current('doctor.index') } " v-if="$page.props.auth.permissions.includes('manage-doctors')">
              ...
              <li :class="{'bg-blue-100 text-gray-800 font-bold border-l-4 border-transparent border-indigo-900 pr-6': route().current('appointment.index') } "  v-if="$page.props.auth.permissions.includes('add-appointment')">
              ...
              <li :class="{'bg-blue-100 text-gray-800 font-bold border-l-4 border-transparent border-indigo-900 pr-6': route().current('service.index') } "  v-if="$page.props.auth.permissions.includes('manage-service')">
              ...
              <li :class="{'bg-blue-100 text-gray-800 font-bold border-l-4 border-transparent border-indigo-900 pr-6': route().current('user.index') } "  v-if="$page.props.auth.permissions.includes('manage-user')">
