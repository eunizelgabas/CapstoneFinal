            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <div>
                    <div class="flex items-center gap-x-3">
                        <h2 class="text-3xl font-bold text-black">List of Medicines</h2>

                        <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full">{{ medCount }} medicine</span>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="mb-5 pt-3">
                                                ...
                                                <div class="-mx-3 flex flex-wrap">
                                                    <div class="w-full px-3">
                                                        ...
                                                        <div class="mb-5">
                                                            <label for="cat_id" class="text-left">Category</label>
                                                            <select id="cat_id" name="cat_id" v-model="form.cat_id" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">
                                                                <option value="" disabled>Select</option>
                                                                <option v-for="mc in categories" :value="mc.id" :key="mc.id"> {{ mc.name }}</option>
                                                            </select>
                                                        </div>
                                                        <div class="mb-5">
                                                            <label for="type_id" class="text-left">Type</label>
                                                            <select id="type_id" name="type_id" v-model="form.type_id" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">
                                                                <option value="" disabled>Select</option>
                                                                <option v-for="mt in types" :value="mt.id" :key="mt.id"> {{ mt.name }}</option>
                                                            </select>
                                                        </div>
                                                        <div class="mb-5">
                                                            <label for="name" class="text-left">Initial Stock</label>
                                                            <input type="number" v-model="form.stock" name="name" id="name" placeholder=""
                                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                        </div>
                                                        <div class="mb-5">
                                                            <label for="measurement" class="text-left">Measurement</label>
                                                            <input type="text" v-model="form.measurement" name="measurement" id="measurement" placeholder=""
                                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="flex item-center justify-center">
                                            <div class="flex item-center justify-center">
                                                <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                    <a href="#" @click="edit(med)" class="btn" title="Edit Medicine">
                                                                        ...
                                                                        <div class="mb-5 pt-3">
                                                                            ...
                                                                            <div class="-mx-3 flex flex-wrap">
                                                                                <div class="w-full px-3">
                                                                                    ...
                                                                                    <div class="mb-5">
                                                                                        <label for="name" class="text-left">Initial Stock</label>
                                                                                        <input type="number" v-model="form.stock" readonly name="name" id="name" placeholder=""
                                                                                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                                                    </div>
                                                                                    <div class="mb-5">
                                                                                        <label for="measurement" class="text-left">Measurement</label>
