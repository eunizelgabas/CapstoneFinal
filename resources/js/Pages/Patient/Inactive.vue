        ...
        <section class="container px-4 py-6 mx-auto">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <div>
                    <div class="flex items-center gap-x-3">
                        <h2 class="text-3xl font-bold text-black">Inactive Patients</h2>

                        <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full">{{ inactivePatientsCount }} inactive patients</span>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 md:flex md:items-center md:justify-between md:w-full">
                ...
                <div class="relative flex items-center  md:mt-0">
                    ...
                    <div class="flex items-center  gap-x-3" v-if="$page.props.auth.permissions.includes('add-patient')">
                        ...
                        <Link href="/patient" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                            <i class="fa-solid fa-user-check"></i>

                            <span>View Active Patient</span>
                        </Link>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full px-2">
                <div class="h-12">
                                        ...
                                        <div class="flex item-center justify-center">
                                            <div class="flex item-center justify-center">
                                                <div class="w-full mr-2 transform hover:text-purple-500 hover:scale-110">
                                                    <Link :href="'/patient/activate/'+ pat.id" method="POST" as="button" title="Activate" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-green-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-green-600 dark:hover:bg-green-500 dark:bg-green-600" >
                                                        <span>Activate</span>
                                                    </Link>
                                                </div>
                                            </div>
                    ...
                    <div v-show="patient.data.length < 1" class="flex flex-col w-full mt-9">
                        <h1 class="text-center text-xl text-gray-400 mb-6">No inactive patient found</h1>
