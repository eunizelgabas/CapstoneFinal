    ...
    <Sidebar>
        ...
        <div class="mt-5">
            ...
            <div v-if="$page.props.flash.error" id="flash-error-message" class=" absolute top-20 right-1 p-4 bg-red-300 border border-gray-300 rounded-md shadow-md">
                ...
                <button v-if="$page.props.auth.permissions.includes('edit-patient')"  @click="edit(patient)" class="px-4 py-2 mr-5 border flex gap-2 items-center bg-blue-600 hover:bg-blue-500 border-blue-200 rounded-lg text-white hover:border-blue-400 hover:text-white hover:shadow transition duration-150">
                                ...
                                <form @submit.prevent = "submit">
                                    <div class="mb-5 pt-3">
                                        ...
                                        <div class="-mx-3 flex flex-wrap">
                                            ...
                                            <div class="w-full px-3" v-if="form.type === 'Student'">
                                                <div class="mb-5">
            ...
            <div class="lg:w-1/2 w-full p-4">
                ...
                <div class=" bg-white shadow-sm flex max-w-xs flex-col items-center rounded-xl border px-4 py-4 text-center md:max-w-lg md:flex-row md:items-start md:text-left">
                    ...
                    <div class="">
                        ...
                        <div class="mb-3"></div>
                        <div class="flex space-x-2">
                            <div class="flex justify-center mt-3 ml-2 mr-4" v-if="patient.status===1">
                        <Link class="border border-red-500 bg-red-500 text-white rounded-md px-3 py-2 m-2 transition duration-500 ease select-none hover:bg-red-600 focus:outline-none focus:shadow-outline" as="button" method="POST"  :href="'/patient/deactivate/'+ patient.id" >Deactivate Patient</Link>

                    </div>
                    <div class="flex justify-center mt-3 ml-2 mr-4" v-if="patient.status===0">
                        <Link class="border border-green-500 bg-green-500 text-white rounded-md px-3 py-2 m-2 transition duration-500 ease select-none hover:bg-green-600 focus:outline-none focus:shadow-outline" as="button" method="POST" :href="'/patient/activate/'+ patient.id" >Activate Patient</Link>
                    </div>
