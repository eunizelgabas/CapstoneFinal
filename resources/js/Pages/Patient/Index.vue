            ...
            <div class="mt-6 md:flex md:items-center md:justify-between md:w-full">
                ...
                <div class="relative flex items-center  md:mt-0">
                    ...
                    <div class="flex items-center  gap-x-3" v-if="$page.props.auth.permissions.includes('add-patient')">
                        ...
                        <Link href="/patient/inactive" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                            <i class="fa-solid fa-user-large-slash"></i>

                            <span>View Inactive Patient</span>
                        </Link>
                    </div>
                </div>
            </div>
                                ...
                                <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="pat in patient.data" :key="pat.id">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110" v-if="$page.props.auth.permissions.includes('edit-patient')">
                                            ...
                                            <div class="w-4  ml-2 mr-2 transform hover:text-red-500 hover:scale-110" v-if="$page.props.auth.permissions.includes('delete-patient')">
