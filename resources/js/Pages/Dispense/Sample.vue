            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <div>
                    <div class="flex items-center gap-x-3">
                        <h2 class="text-3xl font-bold text-black">List of Dispensed Medicines</h2>

                        <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full">{{ dispenseCount }} dispensed</span>
                    </div>
                </div>
            </div>
                ...
                <div class="relative flex items-center  md:mt-0">
                    ...
                    <div class="flex items-center  gap-x-3">
                        <button @click="add()" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                            ...
                            <span class="">Dispense Medicine</span>
                        </button>
                                                ...
                                                <div class="-mx-3 flex flex-wrap">
                                                    <div class="w-full px-3">
                                                        <div class="mb-5">
                                                            ...
                                                            <input type="text" v-model="form.name" name="name" id="purchase_date" placeholder=""
                        ...
                        <table class="min-w-max w-full table-auto">
                            ...
                            <tbody class="text-gray-600 text-sm font-light" >
                                <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="des in dispenses.data" :key="des.id">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <p class="font-medium">{{ des.medicine.name }} pc/s</p>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
