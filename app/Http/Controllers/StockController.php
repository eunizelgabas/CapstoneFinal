...
class StockController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $log_entry = Auth::user()->firstname . " ". Auth::user()->lastname . " purchase " . $stock->qty."  pc/s - " . $stock->medicine->name;
    ...
    public function update(Request $request,Stock $stock) {
        ...
        $log_entry = Auth::user()->firstname . " ". Auth::user()->lastname . " updated a medicine stock - " . $stock->medicine->name;
        event(new UserLog($log_entry));
